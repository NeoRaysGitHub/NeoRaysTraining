...
public class UserDetailServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res)
		...
		ResultSet rs = null;
		System.out.println("in UserDetailServlet class");
		String strNme = req.getParameter("nme");
		String strPwd = req.getParameter("pwd");
		
		try {
			pst = con.prepareStatement("SELECT NAME,PASSWORD,EMAIL,PHONE FROM JSP_CUSTOMER WHERE NAME = ? and PASSWORD = ?");
			...
			if (rs.next()) {
				...
				RequestDispatcher rd = req.getRequestDispatcher("UserDetailPrint.jsp");
				rd.forward(req, res);
			}
		} catch (SQLException sqle) {
			System.out.println(sqle);
