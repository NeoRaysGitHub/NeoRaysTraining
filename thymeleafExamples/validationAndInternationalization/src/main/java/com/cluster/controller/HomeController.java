...
public class HomeController {
	...
	static {
		System.out.println("static....home controller");
	...
	public ModelAndView getHome(ModelAndView mv) {
		System.out.println("getHome....homeContoller");
		...
		mv.setViewName("home");
		{
			System.out.println("end of gethome... controller");
		}
		return mv;
	}
	...
	public ModelAndView createPolicy(ModelAndView mv, @ModelAttribute @Valid PolicyHolder policyHolder,
		...
		System.out.println("createPolicy/.....home controller");
	...
	public ModelAndView createPolicyInfo(ModelAndView mv,@ModelAttribute("policyHolder") PolicyHolder policyHolder){
		System.out.println("createPolicyInfo.....homecontroller");
